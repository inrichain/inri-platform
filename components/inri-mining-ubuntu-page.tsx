import { Server, Pickaxe, Terminal, Wallet } from 'lucide-react'
...
export function InriMiningUbuntuPage() {
  return (
    <InriShell>
      <main>
        <InriHero
          eyebrow="Ubuntu Mining"
          title="Ubuntu mining setup for VPS, server and Linux users."
          description="A professional Ubuntu mining route with consistent cards, commands area and mining navigation."
          actions={[
        ...
        <InriSection eyebrow="Setup steps" title="Start mining with the correct route.">
          <InriCardGrid cols={3}>
            ...
            <InriCard title="Configure miner" text="Use the official mining route and connect to the correct pool or solo configuration." icon={<Server className="h-5 w-5" />} />
