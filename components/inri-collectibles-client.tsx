        ...
        <div className="grid gap-8 px-5 py-8 sm:px-8 lg:grid-cols-[1.05fr_0.95fr] lg:px-10 lg:py-12">
          <div className="flex flex-col justify-center">
            ...
            <div className="mt-6 rounded-[20px] border border-emerald-400/15 bg-emerald-400/[0.06] p-4 text-sm leading-7 text-white/75">
              ...
              <p className="mt-2">
                Country tokens are reward assets. Holders can later create their own country-token pools on INRISwap using iUSD.
              </p>
            </div>
          ...
          <div className="flex items-center justify-center">
            <div className="w-full max-w-[560px] rounded-[28px] border border-cyan-400/18 bg-[linear-gradient(180deg,#061427,#030915)] p-4 shadow-[0_25px_80px_rgba(0,0,0,0.35)]">
              <div className="rounded-[24px] bg-[#020812] p-2">
              ...
              {heroChain?.rewardToken ? (
                <div className="mt-4 rounded-[18px] border border-white/10 bg-white/[0.03] p-4">
                  ...
                  <div className="mt-2 flex flex-wrap items-center gap-2">
                    <code className="break-all rounded bg-black/30 px-2 py-1 text-[12px] text-cyan-200">{heroChain.rewardToken}</code>
                    <Link
      ...
      <section className="grid gap-4 sm:grid-cols-2 xl:grid-cols-3 2xl:grid-cols-4">
        {filteredCountries.map((country) => {
          ...
          return (
            ...
            >
              <div className="p-3">
                <div className="relative overflow-hidden rounded-[20px] bg-[#020812] p-2">
