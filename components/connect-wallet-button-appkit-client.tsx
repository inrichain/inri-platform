...
export function ConnectWalletButtonClient({ compact = false, iconOnly = false }: { compact?: boolean; iconOnly?: boolean }) {
  ensureInriAppKit()
  ...
  const baseButton = iconOnly
    ? 'group inline-flex h-11 w-11 shrink-0 items-center justify-center rounded-[12px] border border-primary/35 bg-[#07131f] text-white shadow-[0_12px_28px_rgba(0,0,0,0.22)] transition-all hover:-translate-y-px hover:border-primary/60 hover:bg-[#082033] disabled:cursor-wait disabled:opacity-70'
    : compact
