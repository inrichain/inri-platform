...
import { InriClientFrame, InriHero, InriSection } from '@/components/inri-premium-model'
    ...
    <InriShell>
      <main>
        <InriHero
          ...
          description="The full championship client stays active below. This page now uses the same approved INRI premium visual standard as the rest of the website."
          actions={[
          ...
          stats={[
            { label: 'Rewards', value: '150,000 INRI' },
            { label: 'Per Block', value: '0.20 INRI' },
            { label: 'Start', value: START_BLOCK.toLocaleString() },
            { label: 'End', value: END_BLOCK.toLocaleString() },
          ]}
        ...
        <InriSection>
          <div className="grid gap-4 md:grid-cols-3">
            {[
              ...
              <div key={String(title)} className="rounded-[28px] border border-cyan-300/12 bg-[radial-gradient(circle_at_top_left,rgba(34,211,238,0.10),transparent_17rem),linear-gradient(180deg,rgba(10,18,31,0.94),rgba(4,9,17,0.98))] p-6 shadow-[0_30px_80px_rgba(0,0,0,0.34),inset_0_1px_0_rgba(255,255,255,0.05)]">
