    ...
    <InriShell>
      <main>
        <InriHero
          ...
          description="Pool stats, recent blocks, payments and miner lookup are preserved inside the approved INRI premium layout."
          actions={[
          ...
          stats={[
            { label: 'Modes', value: 'PPLNS / SOLO' },
            { label: 'Data', value: 'Live' },
            { label: 'Network', value: 'INRI' },
            { label: 'Chain', value: '3777' },
          ]}
          sideTitle="Pool interface with official INRI style."
          sideText="The live pool client stays functional, but now sits inside the same approved premium shell as the rest of the platform."
          sideItems={[
