      ...
      <main className="inri-premium-main">
        <section className="inri-hero-surface">
          <div className="inri-page-container py-10 sm:py-12 lg:py-14">
            <div className="inri-premium-hero-card p-5 sm:p-7 lg:p-9">
              <div className="grid gap-8 xl:grid-cols-[minmax(0,1.05fr)_minmax(320px,0.5fr)] xl:items-end">
                <div>
                  <div className="flex flex-wrap gap-2.5">
                    <span className="inri-chip text-primary">Pool</span>
                    <span className="inri-chip">Mining stats</span>
                ...
                <div className="grid gap-3">
                  {poolHighlights.map((item) => {
                    ...
                    return (
                      <div key={item.title} className="inri-premium-tile flex gap-4 p-4">
